...
```json
[
  { "@context": "https://schema.org", "@type": "Person", "@id": "https://www.cataterapias.cl/#catalina" },
  { "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Inicio", "item": "https://www.cataterapias.cl/" },
    { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://www.cataterapias.cl/blog" }
  ]},
  { "@context": "https://schema.org", "@type": "Blog", "name": "Blog de Terapia Ocupacional", "url": "https://www.cataterapias.cl/blog" }
]
```
...
[
  ...
  { "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Inicio", "item": "https://www.cataterapias.cl/" },
    { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://www.cataterapias.cl/blog" },
    { "@type": "ListItem", "position": 3, "name": "Título del artículo", "item": "https://www.cataterapias.cl/blog/slug" }
  ]},
  { "@context": "https://schema.org", "@type": "BlogPosting", "headline": "Título", "mainEntityOfPage": { "@id": "https://www.cataterapias.cl/blog/slug" } }
]
```
...
- `astro.config.mjs` define `site: "https://www.cataterapias.cl"`, utilizado para canonicals y IDs (`@id`).
- `@astrojs/sitemap` genera el sitemap; la referencia en `robots.txt` es `Sitemap: https://www.cataterapias.cl/sitemap-index.xml`.
